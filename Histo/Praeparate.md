# 1 Haut, Orcein + blaues Polychrom
...
- nur ein ähnliches Präparat (Schweineohr)
	...
	- mit umgrenzenden verhornten Epithel anstelle der univakulären Adipozyten

# 9 Schweineohr Azan + Orcein
- viel elastisches Bindegewebe
	- elastische Fasern in der EZM
	- dünnes Perichondrium
		- stratum fibrosum
		- stratum chondrogenicum
	- keine Gefäße, nur Diffusion
	- Chrondrone meist nur 1-2 Zellen groß
	- mäßig dicht
...
- aussen Faserknorpel, zirkuläre, spiralartige Faserrichtung
	- Fischgrätenmuster
- innen gallertartiger Kern, vieeel Wasser
	- Hyaluran, Proteoglykane
- Druckbelastung -> Zugbelastung
- unscharfer Übergang vom Anulus zum Nucleus

# 11 Schädeldecke Kind, HE
- desmale Ossifikation
	- direkte Knochenbildung aus Bindegewebe
	- Ausgangspunkt: gut vaskularisiertes Mesenchym
	- viele Ausgangsort die fusionieren
	- multipotente Mesenchymzellen differenzieren zu Osteoblasten
	- wächst durch Anlagerung
	- Schädelknochen + Clavicula

# 12 Finger vom Fetus, HE
...
# 13 Femur vom Fetus, HE
- siehe 12

# 14 Knochenquerschnitt, Fuchsin
- Periost
- Lamellenknochen
	- Volkmannsche Kanäle
	- Haversche Kanäle
...
- Mehrschichtig verhorntes Epithel
    - Papillen
    	- Papillae piliformes mit Hornschicht
...
- wie 18, nur in größer und breiter und unverhornt
